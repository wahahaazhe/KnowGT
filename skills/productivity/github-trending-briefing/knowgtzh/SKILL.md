...
4. 挖掘近期最佳（突破 Trending 滞后性）：
   - 从日榜中筛选**不在 Trending 前 5 名**但今日新增 stars 超过 200 的项目，按新增 stars 降序取 Top 5
   - 这些是算法还没推上去但真实热度正在快速上升的潜力项目
   - 如果没有符合条件的项目，可以降低阈值或省略此板块
