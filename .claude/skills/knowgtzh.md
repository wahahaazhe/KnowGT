...
5. 近期最佳挖掘（补充 GitHub Trending 之外）：
   - **高潜力项目识别：即使没进今日 Trending，但符合以下条件的项目：
     - 今日新增 stars > 200（绝对值）
     - 或连续 3 天累计新增 > 500
     - 或近 7 天 stars 增长率 > 50%
     - Contributor 数 > 10 人且最近有新贡献
   - **社区热度指标：Twitter/X、Reddit、Hacker News、Discord 等平台讨论热度
   - **标注来源说明：标注项目可能还没进 Trending，但增长异常的真实热度异常热度异常热门门门
   - 在简报中单独列出「近期最佳」板块，标注判断依据（新增 stars、增长率、社区讨论等
   - 目的：避免 Trending 算法的滞后性，提前发现下一个爆款
